...
describe('WhaleswapFactory', () => {
  ...
  async function createPair(tokens: [string, string]) {
    const bytecode = `0x${WhaleswapPair.evm.bytecode.object}`
    ...
    const pair = new Contract(create2Address, JSON.stringify(WhaleswapPair.abi), provider)
